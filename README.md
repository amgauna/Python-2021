...
# Python Brasil = Google Groups = https://groups.google.com/forum/#!forum/python-brasil

# IDEs para Python = IDEs Download = = https://wiki.python.org.br/IdesPython

# Python Para Web = Artigo Python para Web = https://wiki.python.org.br/PythonParaWeb
